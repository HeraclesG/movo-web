...
export const firstUpper = (value) => value.charAt(0).toUpperCase() + value.slice(1);

export const distanceUnitLongString = (unit, t) => {
  switch (unit) {
    case 'mi':
      return t('sharedMiles');
    case 'nmi':
      return t('sharedNmi');
    case 'km':
    default:
      return t('sharedKilometers');
  }
};

  ...
  return loader ? (
    ...
    <div className={classes.wrapper}>
      ...
      >
        ...
        >
          <div style={{ width: "75%" }}>
            <span style={{ fontSize: "20px", fontWeight: "700" }}>{t("driving")}</span>
        ...
        >
          ...
          <span>
            {distanceFromMeters(tripDistance, distanceUnit).toFixed(2)} {distanceUnitString(distanceUnit, t)}
          </span>
        </div>
      </div>
      <div style={{ padding: "10px 15px", display: "flex" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <span className="refreshButton" onClick={refreshDevice}>
            <RestartAltIcon fontSize="small" /> {t("refreshDeviceRoute")}
          </span>
        </div>
      </div>
    </div>

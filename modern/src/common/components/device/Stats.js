              ...
              <Box className={classes.innerText}>
                {vehicleReport?.distance
                  ? `${distanceFromMeters(
                    ...
                    .toLocaleString()} ${distanceUnitString(distanceUnit, t)}`
            ...
            <Box className={classes.driverData}>
              ...
              >
                {vehicleReport?.maxSpeed
                  ? `${speedFromKnots(vehicleReport?.maxSpeed, speedUnit).toFixed(1)} ${speedUnitString(speedUnit, t)}`
                  : `0  ${speedUnitString(speedUnit, t)}`}
              </Box>
            </Box>
            <Box className={classes.driverData}>
              <Box

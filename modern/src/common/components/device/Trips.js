      ...
      {loading ? (
                    ...
                    <div key={index + 8923}>
                          ...
                          >
                            <div className={classes.listWrapper}>
                              ...
                              >
                                ...
                                {t("total")} {"   "} {distanceUnitLongString(distanceUnit, t)}
                              </span>
                            </div>
                            <Box
                              key="0-0-0-0"
                      ...
                      <div className={classes.listWrapper}>
                        ...
                        >
                          ...
                          {distanceFromMeters(trips?.distance, distanceUnit).toFixed(1)} {t("total")}{" "}
                          {firstUpper(distanceUnitLongString(distanceUnit, t))}
                        </span>
                      </div>
                      {i == 0 &&
                        index == 0 &&
                            ...
                            >
                              ...
                              <Box className={classes.innerText}>
                                ...
                                >
                                  ...
                                  >
                                    {distanceUnitLongString(distanceUnit, t)}
                                  </span>
                                </Typography>
                              </Box>
                            </Box>
        ...
        <div className={classes.deviceBox}>
          <Box className={classes.container}>
            ...
            <Typography className={classes.header}>{t("noTripsYet")}</Typography>

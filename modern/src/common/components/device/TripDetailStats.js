    ...
    <div>
      <div className={classes.tripTimeWrapper}>
        ...
        <div style={{ display: "flex" }}>
          ...
          >
            <span style={{ color: "#006EEA", fontWeight: "700" }}>
            {t("startedAt")} {tripDetail.length ? moment(tripDetail[0]?.startTime).format("h:mm:ss A") : '--/--'}
            </span>
            <span style={{ fontSize: "14px" }}>
            </span>
          </div>
                ...
                <div className={classes.table}>
                  <div className={classes.row}>
                    ...
                    <div>
                      ...
                      <span>{distanceUnitString(distanceUnit, t)}</span>
                    </div>
                  </div>
                  <div className={classes.row}>
                    <span>{t("time")}</span>
                ...
                <div className={classes.table}>
                  <div className={classes.row}>
                    ...
                    <div>
                      ...
                      <span>{speedUnitString(speedUnit, t)}</span>
                    </div>
                  </div>
                  <div className={classes.row}>
                    <span>{t("avgMovingSpeed")}</span>
                    <div>
                      <span className={classes.blueText}>
                        {speedFromKnots(
          ...
          {loading ? (
            ...
            <div className={classes.eventWrapper}>
              {events.length ? (
                ...
                <div className={classes.noData}>{t("noDataFound")}</div>
              )}
            </div>
          )}
        </TabPanel>
